            ...
            <div className="boxfooter text-center text-md-start mt-5" >
              <div className="row mt-3">
                ...
                <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                  ...
                  <p><i className="bi bi-house-door"></i>&nbsp;   Panchawati, Pashan, Pune</p>
                  <p>
                    <i className="bi bi-envelope"></i>
                    <a href="mailto:someone@example.com" className="text-decoration-none"><span style={{ color: 'white' }}>&nbsp;&nbsp;actshms@gmail.com</span></a>
                  </p>
                  <p><i className="bi bi-telephone"></i> +91 95459 68256 </p>
                  <p><i className="bi bi-telephone"></i> +91 93099 59490</p>
                  <p><i className="bi bi-telephone"></i> +91 88059 72881</p>
                  <p><i className="bi bi-telephone"></i> +91 95958 75539</p>
                </div>

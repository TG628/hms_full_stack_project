...
function Register(props) {
    ...
    const addPatient = () => {
        if (firstName && lastName && email && password &&
            phone && dob && adharNo && gender && addressLine1 &&
            addressLine2 && city && state && country && pinCode
        ) {
            ...
            PatientService.register(formData).then((result) => {
            ...
            <div className="container light-style flex-grow-1 container-p-y">
                ...
                <div className="card overflow-hidden">
                                                ...
                                                <div className="card-body">
                                                    <div className="row gutters">
                                                        <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                            <h5 className="mb-2 text-primary fw-bold">Personal Details</h5>
                                                        </div>
                                                        <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                            <div className="form-group">
                                                                ...
                                                                <input type="text" className="form-control" id="fullName" placeholder="Enter First name"
                                                                    onBlur={(event) => { setFirstName(event.target.value); setFirstNameFlag(true) }} required />
                                                            </div>
                                                        ...
                                                        <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                            <div className="form-group">
                                                                ...
                                                                <input type="text" className="form-control" id="fullName1" placeholder="Enter Last name"
                                                                    onBlur={(event) => { setLastName(event.target.value); setLastNameFlag(true) }} required />
                                                            </div>
                                                        ...
                                                        <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                            <div className="form-group">
                                                                ...
                                                                <input type="email" className="form-control" id="eMail" placeholder="Enter email ID"
                                                                    onBlur={Validation.validate_email} onChange={(event) => { setEmail(event.target.value) }} required />
                                                            </div>
                                                        ...
                                                        <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                            <div className="form-group">
                                                                ...
                                                                <input type="text" className="form-control" id="adhaar" placeholder="Enter Adhaar No."
                                                                    ...
                                                                    onChange={(event) => { setAdharNo(event.target.value) }} required />
                                                            </div>
                                                        ...
                                                        <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                            <div className="form-group ">
                                                                ...
                                                                <input type="radio" id="male" name="gender"
                                                                    onClick={(event) => { setGender(event.target.value) }} required />
                                                        ...
                                                        <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                            <div className="form-group">
                                                                ...
                                                                <input type="name" className="form-control" id="adrLine1" placeholder="Address Line 1"
                                                                    onBlur={(event) => { setAddressLine1(event.target.value); setAdr1Flag(true) }} required />
                                                            </div>
                                                        ...
                                                        <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                            <div className="form-group">
                                                                ...
                                                                <input type="name" className="form-control" id="adrLine2" placeholder="Address Line 2"
                                                                    onBlur={(event) => { setAddressLine2(event.target.value); setAdr2Flag(true) }} required />
                                                            </div>
                                                        ...
                                                        <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                            <div className="form-group">
                                                                ...
                                                                <input type="text" className="form-control" id="city" placeholder="Enter City"
                                                                    onBlur={(event) => { setCity(event.target.value); setCityFlag(true) }} required />
                                                            </div>
                                                        ...
                                                        <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                            <div className="form-group">
                                                                ...
                                                                <input type="text" className="form-control" id="state" placeholder="Enter State"
                                                                    onBlur={(event) => { setState(event.target.value); setStateFlag(true) }} required />
                                                            </div>
                                                        ...
                                                        <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                            <div className="form-group">
                                                                ...
                                                                <input type="text" className="form-control" id="country" placeholder="Enter Country"
                                                                    onBlur={(event) => { setCountry(event.target.value); setCountryFlag(true) }} required />
                                                            </div>
                    ...
                    <div className="submit text-right mt-3">
                        <button type="button" className=" btn btn-primary show" onClick={addPatient} >Submit</button>
                        <button type="button" className="btn btn-default show" onClick={goToHome}>Cancel</button>
                    </div>
                </div>

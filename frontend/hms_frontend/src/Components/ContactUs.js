    ...
    return (
        <>
            ...
            <section className="contact-section" >
                <div className="container" style={{ background: "linear-gradient(to left, white, skyblue,white)" }}>
                    <div className="row justify-content-center">
                        <div className="col-md-10 ">
                            <div className="wrapper ">
                                <div className="row no-gutters ">
                                    <div className="col-md-6 ">
                                        <div className="contact-wrap w-100 p-lg-5 p-4 " style={{ background: "linear-gradient(to left, lightblue,#C6F0EE,white,#F6FFFE,white)" }}>
                                            <h3 className="mb-4 " style={{ color: "#d62196", background: "linear-gradient(to left, white, skyblue,white)" }}>Send us a message</h3>
                                            <form
                                                id="contactForm"
                                        ...
                                        <div className="info-wrap w-100 p-lg-5 p-4 img">
                                            ...
                                            <div className="dbox w-100 d-flex align-items-center">
                                                ...
                                                <div className="text pl-3" style={{
                                                    ...
                                                    <p>
                                                        <span>Email : </span>
                                                        <a href="actshospital@hms.com">
                                                            actshospital@hms.com
                                                        </a>
                                                    </p>
                                                </div>
                                            </div>
